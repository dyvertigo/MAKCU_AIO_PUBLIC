...
# 
# Advanced Interface:
# pyinstaller --onefile --noconsole --uac-admin --name MAKCU_Advanced --add-data "assets;assets" --add-data "modules;modules" --add-data "assets/app.manifest;." --add-data "assets/driver;assets/driver" main.py
#
# Wizard Interface:
# pyinstaller --onefile --noconsole --uac-admin --name MAKCU_Wizard --add-data "assets;assets" --add-data "modules;modules" --add-data "assets/app.manifest;." --add-data "assets/driver;assets/driver" main_wizard.py
